...
export default function Auth({ onAuthSuccess, nearbyBuildings, onVerify, currentBuilding, loadingGPS, user, lastScannedCoords }) {
      ...
      <div className="w-full max-w-sm flex-1 sm:flex-initial bg-white p-8 rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 relative flex flex-col justify-center">
        ...
        {loadingGPS ? (
          <div className="text-center space-y-4 animate-pulse py-10">
            ...
            <h2 className="text-lg font-black text-gray-900">Locating...</h2>
          </div>
        ) : (
          <>
